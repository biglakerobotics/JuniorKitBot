...
public class RobotContainer {
 ...
 public final ShootCoral mShootCoral = new ShootCoral(mShooter);
  ...
  //Joystick
  private final Joystick joystick1 = new Joystick (Constants.joyPort);
  ...
  private void configureBindings() {
    ...
    final JoystickButton coralButton = new JoystickButton(joystick1, 1);

    coralButton.whileTrue(mShootCoral);
  }
